...
#                Three methods are .draw_circle , .end_fill , .begin_fill
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                WRITE_YOUR_ANSWER_HERE,_REPLACING_THIS
#
#     f. What does a RoseWindow RENDER method do?
#            Render will draw all the objects in a window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            If the window needs to stay oen until the viewer is done looking at it.
#            Then he can click and go onto the next window
#
